...
const formulario = document.getElementById("shipping-information");
const inputs = document.querySelectorAll( "#shipping-information input")
    ...
    btn_submit.addEventListener('click',  ()=>{
        ...
        function sendEmail(info) {
          ...
          SecureToken :"ef86f175-3efb-431d-b8fb-c5945e32b73b",
            ...
            Subject : "Shipping information change from" + info.user_name + " " + info.last_name,
            Body : `Hi, this message is to change my shipping information 
                    <br> user name: ${info.user_name}
